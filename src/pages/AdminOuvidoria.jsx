                          ...
                          <div className="p-6">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <Button onClick={() => abrirModal(manifestacao)} className="bg-gradient-to-r from-[#00482B] to-[#00703C] hover:from-[#00703C] hover:to-[#008C4A] text-white rounded-full px-6 shadow-lg hover:shadow-xl transition-all">
