                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                          {[
                            ...
                            { icon: Building, label: 'Unidade', value: manifestacao.unidadenome || 'Não informada' },
                            { icon: FileText, label: 'Categoria', value: manifestacao.categoriaNome || 'Não informada' },
                        ...
                        <div className="space-y-4">
                          <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm hover:shadow-md transition-all">
                            ...
                            <p className="font-medium text-gray-900 ml-9">{formatarData(manifestacao.datacriacao)}</p>
                          </div>
