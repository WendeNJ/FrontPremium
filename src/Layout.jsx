          ...
          <div className="max-w-7xl mx-auto px-6 py-3">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden lg:flex items-center gap-1">
                ...
                <Link
                  to="/ouvidoria"
                  className="ouvidoria-btn ml-2 px-5 py-2.5 bg-[#00a651] text-white font-semibold text-sm rounded-full hover:bg-[#008c44] transition-all duration-300 shadow-lg shadow-[#00a651]/30 flex items-center gap-2 relative overflow-hidden group"
                >
              ...
              >
                <nav className="flex flex-col p-6 gap-2">
                  ...
                  <Link
                    to="/ouvidoria"
                    onClick={() => setMobileMenuOpen(false)}
                    className="ouvidoria-mobile mt-2 px-4 py-4 bg-[#00a651] text-white font-semibold rounded-xl hover:bg-[#008c44] transition-all shadow-lg shadow-[#00a651]/30 flex items-center justify-center gap-3 text-base"
                  >
