                ...
                <div className="max-w-7xl mx-auto px-6 py-3">
                    <div className="flex items-center justify-between">
                        ...
                        <nav className="hidden lg:flex items-center gap-1">
                            ...
                            <a 
                                href="#ouvidoria" 
                                className="ouvidoria-btn ml-2 px-5 py-2.5 bg-[#00a651] text-white font-semibold text-sm rounded-full 
                        ...
                        {/* Admin link removido - acessível apenas via URL */}
                    ...
                    {mobileMenuOpen && (
                        ...
                        >
                            <nav className="flex flex-col p-6 gap-2">
                                ...
                                {/* Ouvidoria em Destaque no Mobile */}
                                <a 
                                    href="#ouvidoria" 
                                    onClick={() => setMobileMenuOpen(false)} 
                                    className="ouvidoria-mobile mt-2 px-4 py-4 bg-[#00a651] text-white font-semibold rounded-xl
